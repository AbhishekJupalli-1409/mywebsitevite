...
const Calender = () => {
   ...
   const handleleave = () => {
    ...
    return (
        <>
             <h1 class="text-5xl  m-3 mt-6 font-bold text-gray-900">Calender</h1>
                ...
                <header class="flex items-center justify-between border-b border-gray-200 px-6 py-4 lg:flex-none">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:ml-4 md:flex md:items-center" >
                            <div class="relative" onClick={handleenter} onMouseLeave={handleleave} >
                                ...
                                <div    class={`${hide ? "hidden" : ""} absolute right-0 z-10 mt-3 w-36 origin-top-right overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none`} role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
